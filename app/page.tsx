...
const SESSION_LIFETIME = 10 * 60 * 1000; // 10 minutes
			...
			<div className="wrap">
				<header className="topbar">
				  ...
				  <nav className="nav">
					...
					<a className="pill" href="#profile">Profile</a>
				  </nav>
				</header>
          ...
          <div className="card hero-main">
            ...
            <section id="start-session" className="card section">
              ...
              <form className="quick-form">
                ...
                <button type="button" className="btn btn-primary" onClick={handleGoLive}>
                  Post Session
                </button>
              </form>
            </section>
            ...
            <section id="profile" className="card section">
              ...
              <div className="profile">
                <div className="profile-top">
                  ...
                  <div>
                    <div className="name">Devan</div>
                    <div className="tiny">EA ID: devan_ferreira</div>
                    <div className="tiny">Discord: devan#0001</div>
                  </div>
                </div>
